<form method="post">
    ...
    <div class="form-group">
        <label for="city" style="width: 73%; float: left">Stad</label>
        <label for="zipcode" style="width: 23%; float: right">Postcode</label>

        <input class="form-control" style="width: 73%; float: left; margin-bottom: 15px" type="text" name="city" value="{{isset($person['city']) ? $person['city'] : ""}}">
        <input class="form-control" style="width: 23%; float: right; margin-bottom: 15px" type="text" name="zipcode" value="{{isset($person['zipcode']) ? $person['zipcode'] : ""}}">
    </div>
    <div class="form-group">
